...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        # self.wind1 = Ui_SplashScreen()
        # self.wind1.setupUi(self)
        ...
        self.setting = self.ui.pushButton_3
        ...
        self.setting.clicked.connect(self.show_selected_window)
...
if __name__ == '__main__':
    import sys
    from scratch import Ui_SplashScreen
